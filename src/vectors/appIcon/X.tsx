...
const X: FC<{
  ...
  return (
    <svg width="27" height="27" className={`${className}`} viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        ...
        fill="url(#paint0_linear_510_393)"
      />
      <defs>
        <linearGradient
          id="paint0_linear_510_393"
          x1="13.4998"
          y1="0"
          x2="13.4998"
          y2="27"
